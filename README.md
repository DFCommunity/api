# Delta Force Community API

## Status Badges

Docs Publish and Build Status -> [![Netlify Status](https://api.netlify.com/api/v1/badges/d300b00d-a0fb-4d6b-961c-1b96594058ab/deploy-status)](https://app.netlify.com/sites/dfcommunity-docs/deploys)
...
Build Tools -> [yo](https://yeoman.io)
